...
use common\models\TermTypeSearch;
...
class TermTypeController extends Controller {
    ...
    /**
     * Displays a single TermType model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing TermType model.
    ...
    /**
     * Deletes an existing TermType model.
