                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="doc-file-div">
                                            ...
                                            <a target="_blank" href="<?= yii::$app->homeUrl . 'uploads/inpayment/reference_document/docs/' . $doc->id . '.' . $doc->file ?>" ><button class="btn doc-download"><i class="fa fa-download"></i></button></a>
                                    </div>   
                                            <?php
                                        }
                                    }
