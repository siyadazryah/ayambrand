...
/**
 * OutwardInTransSearch represents the model behind the search form about `common\models\OutwardInTrans`.
 */
class OutwardInTransSearch extends OutwardInTrans
{
    /**
     * @inheritdoc
     */
