...
/**
 * OutwardPartySearch represents the model behind the search form about `common\models\OutwardParty`.
 */
class OutwardPartySearch extends OutwardParty {
