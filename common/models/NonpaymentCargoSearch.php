...
/**
 * NonpaymentCargoSearch represents the model behind the search form about `common\models\NonpaymentCargo`.
 */
class NonpaymentCargoSearch extends NonpaymentCargo
{
    /**
     * @inheritdoc
     */
