...
/**
 * NonpaymentInTransSearch represents the model behind the search form about `common\models\NonpaymentInTrans`.
 */
class NonpaymentInTransSearch extends NonpaymentInTrans
{
    /**
     * @inheritdoc
     */
