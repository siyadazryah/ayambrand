...
/**
 * NonpaymentHeaderSearch represents the model behind the search form about `common\models\NonpaymentHeader`.
 */
class NonpaymentHeaderSearch extends NonpaymentHeader
{
    /**
     * @inheritdoc
     */
