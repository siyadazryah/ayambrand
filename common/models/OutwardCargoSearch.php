...
/**
 * OutwardCargoSearch represents the model behind the search form about `common\models\OutwardCargo`.
 */
class OutwardCargoSearch extends OutwardCargo {
