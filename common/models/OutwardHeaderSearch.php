...
/**
 * OutwardHeaderSearch represents the model behind the search form about `common\models\OutwardHeader`.
 */
class OutwardHeaderSearch extends OutwardHeader
{
    /**
     * @inheritdoc
     */
