...
/**
 * This is the model class for table "nonpayment_summary".
 *
 * @property int $id
 ...
 */
class NonpaymentSummary extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'nonpayment_summary';
    }
    ...
    public static function findGross($id) {
        $total = 0;
        $items = NonpaymentItem::find()->where(['status' => 1, 'header_id' => $id])->all();
        if ($items) {
