...
/**
 * OutwardSummarySearch represents the model behind the search form about `common\models\OutwardSummary`.
 */
class OutwardSummarySearch extends OutwardSummary
{
    /**
     * @inheritdoc
     */
