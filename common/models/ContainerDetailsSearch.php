...
/**
 * ContainerDetailsSearch represents the model behind the search form about `common\models\ContainerDetails`.
 */
class ContainerDetailsSearch extends ContainerDetails {
