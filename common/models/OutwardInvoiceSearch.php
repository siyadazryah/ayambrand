...
/**
 * OutwardInvoiceSearch represents the model behind the search form about `common\models\OutwardInvoice`.
 */
class OutwardInvoiceSearch extends OutwardInvoice {
