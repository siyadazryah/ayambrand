...
/**
 * NonpaymentPartySearch represents the model behind the search form about `common\models\NonpaymentParty`.
 */
class NonpaymentPartySearch extends NonpaymentParty
{
    /**
     * @inheritdoc
     */
