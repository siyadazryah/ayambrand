...
/**
 * NonpaymentInvoiceSearch represents the model behind the search form about `common\models\NonpaymentInvoice`.
 */
class NonpaymentInvoiceSearch extends NonpaymentInvoice
{
    /**
     * @inheritdoc
     */
